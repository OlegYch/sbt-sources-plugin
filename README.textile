...
<pre>
 ...
 > *sources is com.olegych sbt-sources-plugin 0.1.0
 ...
 > sources
 ...
</pre>

You can also replace the default update task by issuing the following command (probably not the best idea because of probable bugs):

<pre>
 > *update is com.olegych sbt-sources-plugin 0.1.0
</pre>
...
class Plugins(info: ProjectInfo) extends PluginDefinition(info) {
  ...
  val sbtSourcesPlugin = "com.olegych" % "sbt-sources-plugin" % "0.1.0"
}
</pre>
